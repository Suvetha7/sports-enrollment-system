...
This project is a data-driven web application designed to streamline sports enrollment and management. It provides a sports program portal with registration, secure login, real-time seat tracking, duplicate prevention, transactional enrollment handling, and analytics dashboards.
